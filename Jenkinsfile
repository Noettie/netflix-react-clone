    ...
    stages{
       ...
       stage('build Docker Image') {
            steps {
                script {
                    // build image
                    docker.build("732550944929.dkr.ecr.us-east-2.amazonaws.com/netflix_app/netflix_app:v1")
               }
            }
        }
        ...
        stage('Push to ECR') {
            steps {
                script{
                    ...
                    docker.withRegistry('https://732550944929.dkr.ecr.us-east-2.amazonaws.com/netflix_app/netflix_app', 'ecr:us-east-2:nottie-ecr') {
                    // build image
